VERSION 5.00
Begin VB.Form CollectorAlignment 
   ...
   Begin VB.CommandButton CollectorAlignmentCancel 
      Caption         =   "Cancel"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
   ...
   Begin VB.Frame CollectorData 
      ...
      End
   End
   Begin VB.CommandButton CollectorAlignmentOk 
      Caption         =   "Ok"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
   ...
   End
End
Attribute VB_Name = "CollectorAlignment"
...
Private Sub CollectorAlignmentCancel_Click()
    CollectorAlignment.Hide
End Sub

Private Sub CollectorAlignmentOk_Click()
    Dim j
    
    Gamma = GammaText.Text
    Beta = BetaText.Text
    RhoG = RhoGText.Text
    
    NumCollectors = NCollectors.Text
    
    
    
    If Gamma = "" Or Beta = "" Or RhoG = "" Then
